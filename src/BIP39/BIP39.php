...
namespace ItHealer\LaravelEvm\BIP39;

use ItHealer\LaravelEvm\BIP39\Exception\Bip39EntropyException;
use ItHealer\LaravelEvm\BIP39\Exception\Bip39MnemonicException;
use ItHealer\LaravelEvm\BIP39\Language\AbstractLanguage;

/**
 * Class BIP39 Mnemonic Generator
 * @package ItHealer\LaravelEvm\BIP39
 */
class BIP39
{
    /**
     * @param \ItHealer\LaravelEvm\BIP39\Language\AbstractLanguage $wordList
     * @param int $wordCount
     * @return \ItHealer\LaravelEvm\BIP39\Mnemonic
     * @throws \ItHealer\LaravelEvm\BIP39\Exception\Bip39EntropyException
     * @throws \ItHealer\LaravelEvm\BIP39\Exception\Bip39MnemonicException
    ...
    /**
     * @param \ItHealer\LaravelEvm\BIP39\Buffer $entropy
     * @param \ItHealer\LaravelEvm\BIP39\Language\AbstractLanguage $wordList
     * @return \ItHealer\LaravelEvm\BIP39\Mnemonic
     * @throws \ItHealer\LaravelEvm\BIP39\Exception\Bip39EntropyException
     */
